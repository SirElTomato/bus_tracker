...
void main() {
  ...
  test("get bus data from repository", () async {
    ...
    BusData mockBusData =
        serializers.deserializeWith(BusData.serializer, parsed);

    when(mockDataSource.getBusData()).thenAnswer((_) async => mockBusData);

    BusData busData = await repository.getBusData();

    expect(busData, mockBusData);
  });
}
