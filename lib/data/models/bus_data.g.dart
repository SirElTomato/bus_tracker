...
class _$BusData extends BusData {
  ...
  _$BusData._({this.minimumInfoUpdates}) : super._() {
  ...
  bool operator ==(Object other) {
    ...
    return other is BusData && minimumInfoUpdates == other.minimumInfoUpdates;
  }

  @override
  int get hashCode {
    return $jf($jc(0, minimumInfoUpdates.hashCode));
  }
...
class BusDataBuilder implements Builder<BusData, BusDataBuilder> {
  ...
  _$BusData build() {
    ...
    try {
      _$result = _$v ??
          new _$BusData._(minimumInfoUpdates: minimumInfoUpdates.build());
    } catch (_) {
